  ...
  return (
    <>
      ...
      <Modal title={editing ? 'Edit Taluka' : 'Add Taluka'} isOpen={open} onClose={() => setOpen(false)} onSave={handleSave} isSaving={saving}>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Taluka Name <span className="text-red-500">*</span></label>
          <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Enter taluka name"
